...
**>> [开始键盘检测](https://starryring.com/zh/toolbox/keyboard/)**

### 3. 🎤 在线麦克风检测与调试
**功能描述：** 一键检测您的麦克风是否正常工作，提供实时音量监测、录音测试和音频波形显示，帮助您调试麦克风设置，确保通话清晰。适用于电脑、手机、平板，全设备支持，无需下载应用。
**>> [开始麦克风检测](https://starryring.com/zh/toolbox/mic/)**

### 4. 🔈 在线扬声器 / 耳机测试工具 (Speaker/Headphone Test)
**功能描述：** 一键检测您的扬声器或耳机是否正常工作，提供左右声道测试、频响测试（扫频音）、音量梯度测试，帮助您判断音频设备是否存在偏音、破音、杂音等问题。适用于电脑、手机、平板，全设备支持，无需下载应用。
**>> [开始扬声器检测](https://starryring.com/zh/toolbox/speaker/)**

### 5. 📷 在线摄像头检测与调试
**功能描述：** 一键检测您的网络摄像头是否正常工作，并提供分辨率、帧率、对焦等详细参数测试，帮助您优化视频通话质量。
**>> [开始摄像头检测](https://starryring.com/zh/toolbox/camera/)**
...
## 如何使用：
1. **选择工具** - 点击上方对应的工具链接
2. **授权设备** - 根据浏览器提示，允许网页访问相应硬件（麦克风、摄像头等）
3. **开始测试** - 按照页面提示操作您的设备
4. **查看结果** - 获取详细的硬件状态报告与性能参数
5. **故障诊断** - 根据测试结果进行问题排查或优化设置
