...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchBar.addEventListener('input', (e) => {
        ...
        if (term.length > 0) {
            ...
            const resultsHint = document.querySelector('.search-hint');
            if (resultsHint) {
                resultsHint.textContent = 'Escriba una palabra clave para encontrar rápidamente la herramienta que necesita';
            }
    ...
    searchBar.addEventListener('focus', function() {
        searchHint.textContent = 'Presione ESC para borrar • Ctrl+K para buscar rápidamente';
    });
