...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchBar.addEventListener('input', (e) => {
        ...
        sections.forEach(section => {
            ...
            if (countElement) {
                countElement.textContent = `${visibleInSection} साधने`;
            }
        ...
        if (resultsHint) {
            if (term.length > 0) {
                resultsHint.textContent = "{count} जुळणारी साधने सापडली".replace('{count}', visibleCardsCount);
            } else {
                resultsHint.textContent = "आपल्याला आवश्यक असलेले साधन द्रुतपणे शोधण्यासाठी कीवर्ड टाइप करा";
            }
        }
    ...
    searchBar.addEventListener('focus', function() {
        searchHint.textContent = "साफ करण्यासाठी ESC दाबा • पटकन शोधण्यासाठी Ctrl+K";
    });
