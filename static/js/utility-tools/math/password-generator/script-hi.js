...
function generate() {
    ...
    generateText.textContent = 'उत्पन्न हो रहा है...';
    ...
    setTimeout(() => {
        try {
            ...
            if (!pool) {
                output.innerText = "कोई वर्ण उपलब्ध नहीं - कृपया बहिष्करण कम करें।";
                updateMeter(0, 0);
                updateAnalysis("", 0);
                resetGenerateButton();
                return;
            ...
            if (requirements.length > len) {
                output.innerText = "चयनित लंबाई के लिए बहुत अधिक आवश्यक प्रकार. लंबाई बढ़ाएँ या आवश्यकताएँ कम करें।";
                updateMeter(0, 0);
                updateAnalysis("", 0);
                resetGenerateButton();
                return;
            ...
            for (let type of requirements) {
                if (getAvailableChars(type).length === 0) {
                    output.innerText = `"${type}" में कोई उपलब्ध वर्ण नहीं है - आवश्यकता को अनचेक करें या इन वर्णों को बाहर करना बंद करें।`;
                    updateMeter(0, 0);
                    updateAnalysis("", 0);
                    resetGenerateButton();
                    return;
            ...
            output.innerText = "पीढ़ी विफल रही. कृपया पुन: प्रयास करें।";
...
function resetGenerateButton() {
    ...
    generateIcon.textContent = '🔄';
    generateText.textContent = 'नया पासवर्ड जनरेट करें';
}
...
function updateCrackTime(entropy) {
    ...
    crackTime.textContent = `अनुमानित दरार समय: ${timeText}`;
}
...
function copyAction() {
    ...
    navigator.clipboard.writeText(text).then(() => {
        ...
        toast.textContent = "प्रतिलिपि विफल. कृपया मैन्युअल रूप से चयन करें और कॉपी करें.";
        ...
        setTimeout(() => {
            ...
            toast.textContent = "पासवर्ड क्लिपबोर्ड पर कॉपी किया गया!";
        }, 2000);
    });
}
...
function exportPasswords() {
    if (passwordHistory.length === 0) {
        alert("निर्यात करने के लिए कोई पासवर्ड इतिहास नहीं.");
        return;
    }
    ...
    toast.textContent = `निर्यातित ${passwordHistory.length} पासवर्ड।`;
    toast.classList.add('show');
    setTimeout(() => {
        toast.classList.remove('show');
    }, 2000);
