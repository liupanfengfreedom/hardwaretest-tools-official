...
function updateTips(method, rate) {
    ...
    if (method === 'compound') {
        rateTag.innerText = "वर्तमान विशिष्ट";
        rateTag.className = "text-[11px] px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full font-medium shadow-sm";
        tipsCard.innerHTML = `\r\n            <div class="flex items-center gap-3 mb-4">\r\n                <span class="w-2 h-2 bg-indigo-400 rounded-full"></span>\r\n                <span class="font-bold text-indigo-300 text-sm tracking-wider">💡 दैनिक यौगिक तर्क</span>\r\n            </div>\r\n            <p class="text-sm leading-relaxed text-slate-300">\r\n                हालाँकि <b class="text-white">वर्तमान खाते</b> कम नाममात्र दर (आमतौर पर 0.2% - 0.35%) की पेशकश करते हैं, वे अक्सर <b class="text-white">दैनिक चक्रवृद्धि </b> लागू करते हैं: प्रत्येक दिन का छोटा ब्याज मूलधन में जोड़ा जाता है, उसके बाद ब्याज अर्जित होता है - "ब्याज पर ब्याज"।\r\n            </p>\r\n            <div class="mt-5 pt-4 border-t border-white/20 text-xs text-slate-400 flex justify-between">\r\n                <span>दैनिक ब्याज फॉर्मूला</span>\r\n                <span class="font-mono text-indigo-300">दैनिक ब्याज = शेष × (${rate}% / 360)</span>\r\n            </div>\r\n        `;
    } else {
        rateTag.innerText = "निश्चित ठेठ";
        rateTag.className = "text-[11px] px-3 py-1 bg-emerald-100 text-emerald-700 rounded-full font-medium shadow-sm";
        tipsCard.innerHTML = `\r\n            <div class="flex items-center gap-3 mb-4">\r\n                <span class="w-2 h-2 bg-emerald-400 rounded-full"></span>\r\n                <span class="font-bold text-emerald-300 text-sm tracking-wider">💎 सावधि जमा साधारण ब्याज</span>\r\n            </div>\r\n            <p class="text-sm leading-relaxed text-slate-300">\r\n                <b class="text-white">सावधि जमा</b> उच्च दरों (उदाहरण के लिए, 2.75%) की पेशकश करते हैं, लेकिन बैंक आमतौर पर <b class="text-white">साधारण ब्याज</b> का उपयोग करते हैं। ब्याज चक्रवृद्धि नहीं होता; यह अवधि के दौरान रैखिक रूप से बढ़ता है।\r\n            </p>\r\n            <div class="mt-5 pt-4 border-t border-white/20 text-xs text-slate-400 flex justify-between">\r\n                <span>कुल ब्याज फॉर्मूला</span>\r\n                <span class="font-mono text-emerald-300">ब्याज = मूलधन × ${rate}% × वर्ष</span>\r\n            </div>\r\n        `;
    }
}
