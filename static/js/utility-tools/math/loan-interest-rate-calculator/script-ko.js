    ...
    function updateCharts(principal, interest, yearlyData) {
        ...
        barChart = new Chart(ctxBar, {
            ...
            data: {
                ...
                datasets: [
                    { label: '주요한', data: yearlyData.map(d => d.principal), backgroundColor: '#3b82f6', stack: 'stack', borderRadius: 8, barPercentage: 0.65 },
                    { label: '관심', data: yearlyData.map(d => d.interest), backgroundColor: '#fbbf24', stack: 'stack', borderRadius: 8, barPercentage: 0.65 }
                ]
            },
            options: {
                responsive: true,
