let totalBytesDecrypted = 0;
  ...
  function loadPemFile(input) {
    ...
    function validatePemText(text) {
      ...
      successMsg.textContent = `लोड की गई "${file.name}" - ${label}, ${bodyLines.length} बेस64 लाइनें।`;
  ...
  function updateHints() {
    ...
    document.getElementById('infoMode').textContent    = 'ओएईपी / ' + hash;
    document.getElementById('infoSecurity').textContent = 'HIGH';
    document.getElementById('infoSecSub').textContent   = 'असममित';
  }
  ...
  function getCipherBytes() {
    ...
    } catch { throw new Error('अमान्य बेस64 सिफरटेक्स्ट। कृपया इनपुट जांचें.'); }
  }
  ...
  async function runDecrypt() {
    ...
    try {
      ...
      if (!privPem) throw new Error('कृपया एक निजी कुंजी दर्ज करें');

      let privDer;
      try { privDer = pemToDer(privPem); }
      catch { throw new Error('अमान्य निजी कुंजी प्रारूप. कृपया पीईएम का उपयोग करें.'); }
      ...
      try {
        ...
        throw new Error('निजी कुंजी आयात विफल - ' + (e.message || 'invalid format, mismatched public key, or hash mismatch'));
      }
      ...
      try {
        ...
        throw new Error('डिक्रिप्शन विफल - कृपया सत्यापित करें कि निजी कुंजी एन्क्रिप्शन सार्वजनिक कुंजी से मेल खाती है, और हैश एल्गोरिदम और सिफरटेक्स्ट सही हैं।');
      }
      ...
      setStatus(`✓ डिक्रिप्शन सफल - ${formatBytes(cipherBytes.length)} -> ${formatBytes(decBytes.length)} (RSA-OAEP/${hash} ${document.getElementById('keySize').value}-बिट)`, 'success');
    } catch(e) {
      document.getElementById('outputText').value = '';
  ...
  function clearInput() {
    ...
    setStatus('तैयार - एक निजी कुंजी और सिफरटेक्स्ट चिपकाएँ, फिर डिक्रिप्ट पर क्लिक करें');
  }
