...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchBar.addEventListener('input', (e) => {
        ...
        if (term.length > 0) {
            ...
            if (resultsHint) {
                resultsHint.textContent = `${visibleCardsCount} मिलान उपकरण मिले`;
            }
        } else {
            const resultsHint = document.querySelector('.search-hint');
            if (resultsHint) {
                resultsHint.textContent = 'आपको जिस टूल की आवश्यकता है उसे तुरंत ढूंढने के लिए एक कीवर्ड टाइप करें';
            }
    ...
    searchBar.addEventListener('focus', function() {
        searchHint.textContent = 'शीघ्रता से खोजने के लिए • Ctrl+K साफ़ करने के लिए ESC दबाएँ';
    });
