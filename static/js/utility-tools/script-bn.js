...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchBar.addEventListener('input', (e) => {
        ...
        sections.forEach(section => {
            ...
            if (countElement) {
                countElement.textContent = `${visibleInSection} টুলস`;
            }
        ...
        if (resultsHint) {
            if (term.length > 0) {
                resultsHint.textContent = "{count}টি মিলে যাওয়া টুল পাওয়া গেছে".replace('{count}', visibleCardsCount);
            } else {
                resultsHint.textContent = "আপনার প্রয়োজনীয় টুলটি দ্রুত খুঁজে পেতে একটি কীওয়ার্ড টাইপ করুন";
            }
        }
    ...
    searchBar.addEventListener('focus', function() {
        searchHint.textContent = "পরিষ্কার করতে ESC টিপুন • দ্রুত অনুসন্ধান করতে Ctrl+K";
    });
