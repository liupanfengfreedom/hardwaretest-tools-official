...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchBar.addEventListener('input', (e) => {
        ...
        sections.forEach(section => {
            ...
            if (countElement) {
                countElement.textContent = `${visibleInSection} ఉపకరణాలు`;
            }
        ...
        if (resultsHint) {
            if (term.length > 0) {
                resultsHint.textContent = "సరిపోలే {count} సాధనాలు కనుగొనబడ్డాయి".replace('{count}', visibleCardsCount);
            } else {
                resultsHint.textContent = "మీకు అవసరమైన సాధనాన్ని త్వరగా కనుగొనడానికి కీవర్డ్‌ని టైప్ చేయండి";
            }
        }
    ...
    searchBar.addEventListener('focus', function() {
        searchHint.textContent = "క్లియర్ చేయడానికి ESC నొక్కండి • త్వరగా వెతకడానికి Ctrl+K";
    });
