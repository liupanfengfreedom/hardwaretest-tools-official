...
async function sendRequest() {
  ...
  document.getElementById('response').textContent = 'Đang tải...';
  ...
  try {
    ...
    alert('Lỗi định dạng JSON của tiêu đề yêu cầu');
    return;
  }
