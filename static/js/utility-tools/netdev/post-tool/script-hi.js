...
async function sendRequest() {
  ...
  if (!url) { alert('कृपया यूआरएल दर्ज करें'); return; }

  // Record history
  saveToHistory(url);

  document.getElementById('response').textContent = 'लोड हो रहा है...';
  ...
  try {
    ...
    alert('अनुरोध हेडर JSON प्रारूप त्रुटि');
    return;
  }
