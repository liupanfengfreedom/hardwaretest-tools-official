...
document.fonts.ready.then(() => {
    console.log("Alle Schriftarten wurden erfolgreich geladen");
}).catch((error) => {
    console.warn("Einige Schriftarten konnten nicht geladen werden:", error);
});
