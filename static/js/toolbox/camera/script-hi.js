...
function showPermissionRequestModal() {
    return new Promise((resolve) => {
        ...
        title.textContent = 'कैमरा अनुमति अनुरोध';
        title.style.cssText = `
            color: var(--text-main);
            margin-top: 0;
            margin-bottom: 20px;
        ...
        description.textContent = 'प्रदर्शन मापदंडों का पता लगाने के लिए वेबकैम टेस्ट टूल को आपके कैमरा डिवाइस तक पहुंच की आवश्यकता है। कृपया पुष्टि करें कि क्या आप प्रवेश की अनुमति देते हैं?';
        ...
        noticeText.textContent = 'हम गारंटी देते हैं: सभी डेटा केवल स्थानीय रूप से संसाधित किया जाता है, किसी सर्वर पर अपलोड नहीं किया जाता है।';
        ...
        allowButton.textContent = 'उपयोग की अनुमति दें';
        ...
        denyButton.textContent = 'पहुँच को अस्वीकार';
...
async function initCameraTool() {
    try {
        ...
        statusText.textContent = 'उपयोगकर्ता की पुष्टि की प्रतीक्षा है...';
        ...
        if (!userConfirmed) {
            ...
            statusText.textContent = 'उपयोगकर्ता को प्रवेश की अनुमति नहीं दी गई';
            updateStatus('error');
            
            // Delay redirect to let user see status change
            setTimeout(() => {
                window.location.href = '/हाय/टूलबॉक्स/';
            }, 1000);
            return;
        }
        
        // User agreed, continue with original process
        statusText.textContent = 'अनुमति का अनुरोध किया जा रहा है...';
...
async function startStream() {
    ...
    try {
        ...
        updateStatus('active');
        statusText.textContent = 'सामान्य रूप से चल रहा है';
        ...
        updateStatus('error');
        statusText.textContent = 'प्रारंभ विफल: ' + (error.name || 'अज्ञात');
...
function analyzeVideoTrack(track) {
    ...
    deviceLabel.textContent = track.label || 'अज्ञात उपकरण';
    ...
    capTable.innerHTML = capHtml || `<tr><td colspan="2"> विस्तृत ड्राइवर जानकारी प्राप्त करने में असमर्थ</td></tr>`;
}
...
function handleError(error) {
    ...
    statusText.textContent = 'गलती: ' + errorMessage;
    statusText.style.color = "#ef4444";
    
    // Show user-friendly prompt
    if (window.confirm('कैमरा एक्सेस विफल: ' + errorMessage + '\\n\\nसहायता दस्तावेज़ देखें?')) {
...
function cleanup() {
    ...
    statusText.textContent = 'रुक गया';
    statusText.style.color = "var(--text-muted)";
}

// Event listeners (unchanged structure)
videoSelect.onchange = () => {
    statusText.textContent = 'स्विचिंग...';
    updateStatus('loading');
...
document.getElementById('btn-mirror').onclick = () => {
    ...
    btn.textContent = isMirrored ? 'मिरर फ्लिप' : 'मिरर रद्द करें';
};
...
window.addEventListener('load', () => {
    ...
    if (!navigator.mediaDevices || !navigator.mediaDevices.getUserMedia) {
        alert('आपका ब्राउज़र कैमरा एक्सेस का समर्थन नहीं करता. कृपया क्रोम, फायरफॉक्स, एज या सफारी जैसे आधुनिक ब्राउज़र का उपयोग करें।');
        return;
    }
