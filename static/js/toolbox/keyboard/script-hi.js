    ...
    if (savedAutoScroll !== null) {
        ...
        if (toggleBtn) {
            toggleBtn.innerHTML = logAutoScroll ? 
                '<i class="fas fa-scroll"></i> ऑटो स्क्रॉल ऑन' : 
                '<i class="fas fa-scroll"></i> स्वतः स्क्रॉल बंद';
        }
    }
}
...
window.toggleLog = function() {
    ...
    if (logContent && logContainer) {
        if (logContainer.style.maxHeight && logContainer.style.maxHeight !== '0px') {
            ...
            document.getElementById('toggle-log').innerHTML = '<i class="fas fa-eye"></i> लॉग दिखाएँ';
        } else {
            logContainer.style.maxHeight = '500px';
            logContainer.style.opacity = '1';
            document.getElementById('toggle-log').innerHTML = '<i class="fas fa-eye-slash"></i> लॉग छिपाएँ';
        }
    }
}
...
window.startIntervalTest = function() {
    ...
    testStartEntry.innerHTML = `\r\n        <span class="log-time">${timeStr}</span>\r\n        <span class="log-message">कुंजी अंतराल परीक्षण प्रारंभ करना - कृपया एक ही कुंजी को बार-बार तेजी से दबाएं</span>\r\n    `;
...
window.startDiagnosis = function() {
    ...
    const diagnosticSteps = [
        {
            title: "🔍 चरण 1: सिंगल की फंक्शन टेस्ट",
        ...
        {
            title: "⏱️ चरण 2: कुंजी अंतराल का पता लगाना",
        ...
        {
            title: "🎮 चरण 3: एनकेआरओ एंटी-घोस्टिंग टेस्ट",
        ...
        {
            title: "⚡ चरण 4: प्रतिक्रिया विलंब परीक्षण",
        ...
        {
            title: "🔄 चरण 5: मुख्य संघर्ष का पता लगाना",
...
function createDiagnosisPanel(steps) {
    ...
    panel.innerHTML = `\r\n        <div class="diagnosis-header">\r\n            <h3><i class="fas fa-stethoscope"></i> कीबोर्ड डायग्नोस्टिक मोड</h3>\r\n            <button class="close-diagnosis"><i class="fas fa-times"></i></button>\r\n        </div>\r\n        <div class="diagnosis-progress">\r\n            <div class="progress-bar"><div class="progress-fill" style="width: 20%;"></div></div>\r\n            <div class="progress-text">चरण 1/${steps.length}</div>\r\n        </div>\r\n        <div class="diagnosis-content">\r\n            <div class="step-current">\r\n                <h4 id="step-title">${steps[0].title}</h4>\r\n                <p id="step-instruction">${steps[0].instruction}</p>\r\n                <div class="step-requirements">\r\n                    <strong> जांच बिंदु: </strong> ${steps[0].check}<br>\r\n                    <small><i class="far fa-clock"></i> सुझाया गया समय: ${steps[0].time} सेकंड</small>\r\n                </div>\r\n            </div>\r\n            <div class="step-results" id="step-results"></div>\r\n        </div>\r\n        <div class="diagnosis-actions">\r\n            <button class="btn-step" id="prev-step"><i class="fas fa-arrow-left"></i> पिछला</button>\r\n            <button class="btn-step" id="next-step">अगला <i class="fas fa-arrow-right"></i></button>\r\n            <button class="btn-complete" id="complete-diagnosis">पूर्ण निदान और रिपोर्ट तैयार करें</button>\r\n        </div>\r\n    `;
    ...
    function updateProgress() {
        ...
        document.querySelector('.progress-text').textContent = `चरण ${currentStep + 1}/${steps.length}`;
        ...
        document.querySelector('.step-requirements').innerHTML = `\r\n            <strong> जांच बिंदु: </strong> ${steps[currentStep].check}<br>\r\n            <small><i class="far fa-clock"></i> सुझाया गया समय: ${steps[currentStep].time} सेकंड</small>\r\n        `;
    }
    ...
    document.querySelector('.close-diagnosis').addEventListener('click', () => {
        if (confirm('क्या आप वाकई डायग्नोस्टिक मोड से बाहर निकलना चाहते हैं? अपूर्ण परिणाम सहेजे नहीं जायेंगे.')) {
            panel.remove();
            diagnosisActive = false;
        }
    });
