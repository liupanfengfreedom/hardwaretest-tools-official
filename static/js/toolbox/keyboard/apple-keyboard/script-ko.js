(function() {
    ...
    function updateConcurrent() {
        ...
        concurrentInfo.innerText = `현재:${current} 최대:${maxConcurrent}`;
    }
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> 로그가 삭제되었습니다</div>';
    });
    ...
    document.addEventListener('keydown', (e) => {
        ...
        lastKeyDisplay.innerText = e.key === ' ' ? '공간' : e.key;
        keyCodeDisplay.innerText = code;
        infoKey.innerText = e.key === ' ' ? '공간' : e.key;
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> 테스트 재설정</div>';
