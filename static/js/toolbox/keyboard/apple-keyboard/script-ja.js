(function() {
    ...
    function updateConcurrent() {
        ...
        concurrentInfo.innerText = `現在:${current} 最大:${maxConcurrent}`;
    }
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> ログがクリアされました</div>';
    });
    ...
    document.addEventListener('keydown', (e) => {
        ...
        lastKeyDisplay.innerText = e.key === ' ' ? '空間' : e.key;
        keyCodeDisplay.innerText = code;
        infoKey.innerText = e.key === ' ' ? '空間' : e.key;
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> テストリセット</div>';
