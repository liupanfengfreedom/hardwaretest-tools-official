(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'advertencia' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="entrada de registro"><span class="marca de tiempo">⏱️</span> Registro borrado</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="entrada de registro"><span class="marca de tiempo">⏱️</span> Restablecimiento de prueba</div>';
        addLog('🔄 Los contadores se reinician, prueba nuevamente');
    });
    ...
    updateConcurrent();
    addLog('✅ Listo (detección de chat por tecla, mantener presionado se ignora)');
})();