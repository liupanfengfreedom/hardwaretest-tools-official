(function() {
    ...
    function updateConcurrent() {
        ...
        concurrentInfo.innerText = `अभी:${current} अधिकतम:${maxConcurrent}`;
    }
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> लॉग साफ़ किया गया</div>';
    });
    ...
    document.addEventListener('keydown', (e) => {
        ...
        lastKeyDisplay.innerText = e.key === ' ' ? 'अंतरिक्ष' : e.key;
        keyCodeDisplay.innerText = code;
        infoKey.innerText = e.key === ' ' ? 'अंतरिक्ष' : e.key;
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> टेस्ट रीसेट</div>';
