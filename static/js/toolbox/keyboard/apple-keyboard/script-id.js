(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'peringatan' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Log dibersihkan</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Tes ulang</div>';
        addLog('🔄 Penghitung disetel ulang, uji lagi');
    });
    ...
    updateConcurrent();
    addLog('✅ Siap (deteksi obrolan per tombol, diabaikan terus)');
})();