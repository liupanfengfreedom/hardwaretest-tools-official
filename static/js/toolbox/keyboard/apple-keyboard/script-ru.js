(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'предупреждение' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Журнал очищен</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Сброс теста</div>';
        addLog('🔄 Сброс счетчиков, тест еще раз');
    });
    ...
    updateConcurrent();
    addLog('✅ Готов (обнаружение болтовни для каждой клавиши, удержание игнорируется)');
})();