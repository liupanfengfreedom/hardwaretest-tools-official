(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'எச்சரிக்கை' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> பதிவு அழிக்கப்பட்டது</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        addLog('🔄 கவுண்டர்களை மீட்டமைத்து, மீண்டும் சோதிக்கவும்');
    });
    ...
    updateConcurrent();
    addLog('✅ தயார் (ஒரு விசைக்கு உரையாடல் கண்டறிதல், புறக்கணிக்கப்பட்டது)');
})();