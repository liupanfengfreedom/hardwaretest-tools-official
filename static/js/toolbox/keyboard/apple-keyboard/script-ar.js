(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'تحذير' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> تم مسح السجل</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> إعادة تعيين الاختبار</div>';
        addLog('🔄 إعادة ضبط العدادات، الاختبار مرة أخرى');
    });
    ...
    updateConcurrent();
    addLog('✅ جاهز (الكشف عن المحادثات لكل مفتاح، مع الاستمرار في التجاهل)');
})();