(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'انتباہ' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry">_<span class="timestamp">⏱️</span> لاگ کلیئر کر دیا گیا</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry">_<span class="timestamp">⏱️</span> ٹیسٹ ری سیٹ</div>';
        addLog('🔄 کاؤنٹرز دوبارہ ترتیب دیں، دوبارہ ٹیسٹ کریں۔');
    });
    ...
    updateConcurrent();
    addLog('✅ تیار (ہر کلید پر چیٹر کا پتہ لگانا، نظر انداز کر دیا گیا)');
})();