(function() {
    ...
    function updateConcurrent() {
        ...
        concurrentInfo.innerText = `Bây giờ:${current} Tối đa:${maxConcurrent}`;
    }
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Đã xóa nhật ký</div>';
    });
    ...
    document.addEventListener('keydown', (e) => {
        ...
        lastKeyDisplay.innerText = e.key === ' ' ? 'Không gian' : e.key;
        keyCodeDisplay.innerText = code;
        infoKey.innerText = e.key === ' ' ? 'Không gian' : e.key;
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Thiết lập lại kiểm tra</div>';
