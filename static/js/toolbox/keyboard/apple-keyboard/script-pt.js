(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'aviso' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Log limpo</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Redefinição de teste</div>';
        addLog('🔄 Contadores redefinidos, teste novamente');
    });
    ...
    updateConcurrent();
    addLog('✅ Pronto (detecção de conversa por tecla, espera ignorada)');
})();