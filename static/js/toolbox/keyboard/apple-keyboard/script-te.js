(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'హెచ్చరిక' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> లాగ్ క్లియర్ చేయబడింది</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> టెస్ట్ రీసెట్</div>';
        addLog('🔄 కౌంటర్లను రీసెట్ చేయండి, మళ్లీ పరీక్షించండి');
    });
    ...
    updateConcurrent();
    addLog('✅ సిద్ధంగా ఉంది (కీ ప్రతి కబురు గుర్తింపు, విస్మరించబడింది పట్టుకోండి)');
})();