(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'সতর্কতা' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry">_<span class="timestamp">⏱️</span> লগ সাফ করা হয়েছে</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry">_<span class="timestamp">⏱️</span> টেস্ট রিসেট</div>';
        addLog('🔄 কাউন্টার রিসেট করুন, আবার পরীক্ষা করুন');
    });
    ...
    updateConcurrent();
    addLog('✅ প্রস্তুত (কী প্রতি বকবক সনাক্তকরণ, উপেক্ষা করে ধরে রাখুন)');
})();