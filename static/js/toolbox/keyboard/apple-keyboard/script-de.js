(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'Warnung' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Protokoll gelöscht</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        addLog('🔄 Zähler zurückgesetzt, erneut testen');
    });
    ...
    updateConcurrent();
    addLog('✅ Bereit (Rattererkennung pro Taste, Halten ignoriert)');
})();