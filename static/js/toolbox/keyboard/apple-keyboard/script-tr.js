(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'uyarı' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class = "log-entry"><span class = "timestamp">⏱️</span> Günlük temizlendi</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class = "log-entry"><span class = "timestamp">⏱️</span> Test sıfırlama</div>';
        addLog('🔄 Sayaçlar sıfırlandı, tekrar test edin');
    });
    ...
    updateConcurrent();
    addLog('✅ Hazır (tuş başına gevezelik tespiti, basılı tutma göz ardı edilir)');
})();