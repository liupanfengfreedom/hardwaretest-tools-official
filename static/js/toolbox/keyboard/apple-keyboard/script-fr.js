(function() {
    ...
    function addLog(message, isWarning = false) {
        ...
        entry.className = 'log-entry' + (isWarning ? 'avertissement' : '');
        const now = new Date();
    ...
    clearLogBtn.addEventListener('click', () => {
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Journal effacé</div>';
    });
    ...
    resetButton.addEventListener('click', () => {
        ...
        logEntries.innerHTML = '<div class="log-entry"><span class="timestamp">⏱️</span> Test de réinitialisation</div>';
        addLog('🔄 Réinitialisation des compteurs, testez à nouveau');
    });
    ...
    updateConcurrent();
    addLog('✅ Prêt (détection de bavardage par touche, maintien ignoré)');
})();