...
let currentChannel = "উভয় চ্যানেল"; // Default channel mode
...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'সক্রিয়';
    }
...
function setChannelMode(mode) {
    ...
    if (mode === 'বাম চ্যানেল') document.getElementById('leftChannelBtn').classList.add('active');
    else if (mode === 'ডান চ্যানেল') document.getElementById('rightChannelBtn').classList.add('active');
    else if (mode === 'উভয় চ্যানেল') document.getElementById('bothChannelsBtn').classList.add('active');
}
...
function stopAll() {
    ...
    playStopText.innerText = 'প্লেব্যাক শুরু করুন';
    audioStatusDisplay.innerText = 'থেমে গেল';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = 'প্লেব্যাক বন্ধ করুন';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = 'সাইন ওয়েভ বাজানো';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = 'ঝাড়ু দেওয়া';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'সুইপ সম্পূর্ণ';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = 'প্লেব্যাক বন্ধ করুন';
    currentFrequencyDisplay.innerText = type === 'white' ? 'সাদা গোলমাল' : 'গোলাপী গোলমাল';
    audioStatusDisplay.innerText = (type === 'white' ? 'White' : 'Pink') + 'নয়েজ বাজানো';
...
document.getElementById('leftChannelBtn').onclick = () => setChannelMode('বাম চ্যানেল');
document.getElementById('bothChannelsBtn').onclick = () => setChannelMode('উভয় চ্যানেল');
document.getElementById('rightChannelBtn').onclick = () => setChannelMode('ডান চ্যানেল');
