...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'アクティブ化された';
    }
...
function stopAll() {
    ...
    playStopText.innerText = '再生を開始する';
    audioStatusDisplay.innerText = '停止しました';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = '再生を停止する';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = '正弦波演奏';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = '掃き掃除';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'スイープ完了';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = '再生を停止する';
    currentFrequencyDisplay.innerText = type === 'white' ? 'ホワイトノイズ' : 'ピンクノイズ';
    audioStatusDisplay.innerText = (type === 'white' ? '白' : 'ピンク') + ' ノイズ再生';
