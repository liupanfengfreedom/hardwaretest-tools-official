...
let currentChannel = "दोन्ही चॅनेल"; // Default channel mode
...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'सक्रिय केले';
    }
...
function setChannelMode(mode) {
    ...
    if (mode === 'डावे चॅनल') document.getElementById('leftChannelBtn').classList.add('active');
    else if (mode === 'उजवे चॅनेल') document.getElementById('rightChannelBtn').classList.add('active');
    else if (mode === 'दोन्ही चॅनेल') document.getElementById('bothChannelsBtn').classList.add('active');
}
...
function stopAll() {
    ...
    playStopText.innerText = 'प्लेबॅक सुरू करा';
    audioStatusDisplay.innerText = 'थांबला';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = 'प्लेबॅक थांबवा';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = 'साइन वेव्ह खेळत आहे';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = 'झाडून';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'स्वीप पूर्ण';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = 'प्लेबॅक थांबवा';
    currentFrequencyDisplay.innerText = type === 'white' ? 'पांढरा आवाज' : 'गुलाबी आवाज';
    audioStatusDisplay.innerText = (type === 'white' ? 'White' : 'Pink') + 'आवाज खेळत आहे';
...
document.getElementById('leftChannelBtn').onclick = () => setChannelMode('डावे चॅनल');
document.getElementById('bothChannelsBtn').onclick = () => setChannelMode('दोन्ही चॅनेल');
document.getElementById('rightChannelBtn').onclick = () => setChannelMode('उजवे चॅनेल');
