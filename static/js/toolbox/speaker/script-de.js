...
let currentChannel = "Beide Kanäle"; // Default channel mode
...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'Aktiviert';
    }
...
function setChannelMode(mode) {
    ...
    if (mode === 'Linker Kanal') document.getElementById('leftChannelBtn').classList.add('active');
    else if (mode === 'Rechter Kanal') document.getElementById('rightChannelBtn').classList.add('active');
    else if (mode === 'Beide Kanäle') document.getElementById('bothChannelsBtn').classList.add('active');
}
...
function stopAll() {
    ...
    playStopText.innerText = 'Starten Sie die Wiedergabe';
    audioStatusDisplay.innerText = 'Angehalten';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = 'Stoppen Sie die Wiedergabe';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = 'Sinuswellenspiel';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = 'Fegen';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'Sweep abgeschlossen';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = 'Stoppen Sie die Wiedergabe';
    currentFrequencyDisplay.innerText = type === 'white' ? 'Weißes Rauschen' : 'Rosa Rauschen';
    audioStatusDisplay.innerText = (type === 'white' ? 'White' : 'Pink') + 'Geräusch beim Spielen';
...
document.getElementById('leftChannelBtn').onclick = () => setChannelMode('Linker Kanal');
document.getElementById('bothChannelsBtn').onclick = () => setChannelMode('Beide Kanäle');
document.getElementById('rightChannelBtn').onclick = () => setChannelMode('Rechter Kanal');
