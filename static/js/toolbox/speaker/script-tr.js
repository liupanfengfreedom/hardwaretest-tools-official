...
let currentChannel = "Her İki Kanal"; // Default channel mode
...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'Etkinleştirildi';
    }
...
function setChannelMode(mode) {
    ...
    if (mode === 'Sol Kanal') document.getElementById('leftChannelBtn').classList.add('active');
    else if (mode === 'Sağ Kanal') document.getElementById('rightChannelBtn').classList.add('active');
    else if (mode === 'Her İki Kanal') document.getElementById('bothChannelsBtn').classList.add('active');
}
...
function stopAll() {
    ...
    playStopText.innerText = 'Oynatmayı Başlat';
    audioStatusDisplay.innerText = 'Durduruldu';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = 'Oynatmayı Durdur';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = 'Sinüs Dalgası Oynama';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = 'Süpürme';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'Süpürme Tamamlandı';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = 'Oynatmayı Durdur';
    currentFrequencyDisplay.innerText = type === 'white' ? 'Beyaz Gürültü' : 'Pembe Gürültü';
    audioStatusDisplay.innerText = (type === 'white' ? 'White' : 'Pink') + 'Gürültü Çalma';
...
document.getElementById('leftChannelBtn').onclick = () => setChannelMode('Sol Kanal');
document.getElementById('bothChannelsBtn').onclick = () => setChannelMode('Her İki Kanal');
document.getElementById('rightChannelBtn').onclick = () => setChannelMode('Sağ Kanal');
