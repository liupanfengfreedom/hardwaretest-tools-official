...
let currentChannel = "రెండు ఛానెల్‌లు"; // Default channel mode
...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'యాక్టివేట్ చేయబడింది';
    }
...
function setChannelMode(mode) {
    ...
    if (mode === 'ఎడమ ఛానెల్') document.getElementById('leftChannelBtn').classList.add('active');
    else if (mode === 'కుడి ఛానెల్') document.getElementById('rightChannelBtn').classList.add('active');
    else if (mode === 'రెండు ఛానెల్‌లు') document.getElementById('bothChannelsBtn').classList.add('active');
}
...
function stopAll() {
    ...
    playStopText.innerText = 'ప్లేబ్యాక్ ప్రారంభించండి';
    audioStatusDisplay.innerText = 'ఆగిపోయింది';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = 'ప్లేబ్యాక్ ఆపివేయండి';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = 'సైన్ వేవ్ ప్లే అవుతోంది';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = 'స్వీపింగ్';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'స్వీప్ పూర్తి';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = 'ప్లేబ్యాక్ ఆపివేయండి';
    currentFrequencyDisplay.innerText = type === 'white' ? 'వైట్ నాయిస్' : 'పింక్ శబ్దం';
    audioStatusDisplay.innerText = (type === 'white' ? 'White' : 'Pink') + 'నాయిస్ ప్లేయింగ్';
...
document.getElementById('leftChannelBtn').onclick = () => setChannelMode('ఎడమ ఛానెల్');
document.getElementById('bothChannelsBtn').onclick = () => setChannelMode('రెండు ఛానెల్‌లు');
document.getElementById('rightChannelBtn').onclick = () => setChannelMode('కుడి ఛానెల్');
