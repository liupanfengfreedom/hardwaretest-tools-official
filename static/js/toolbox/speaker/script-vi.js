...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'Đã kích hoạt';
    }
...
function stopAll() {
    ...
    playStopText.innerText = 'Bắt đầu phát lại';
    audioStatusDisplay.innerText = 'Đã dừng';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = 'Dừng phát lại';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = 'Chơi sóng hình sin';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = 'Quét';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'Quét hoàn tất';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = 'Dừng phát lại';
    currentFrequencyDisplay.innerText = type === 'white' ? 'Tiếng ồn trắng' : 'Tiếng ồn màu hồng';
    audioStatusDisplay.innerText = (type === 'white' ? 'Trắng' : 'Hồng') + ' Chơi tiếng ồn';
