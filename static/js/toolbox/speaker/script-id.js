...
let currentChannel = "Kedua Saluran"; // Default channel mode
...
function initAudio() {
    if (!audioCtx) {
        ...
        drawVisualizer();
        audioStatusDisplay.innerText = 'Diaktifkan';
    }
...
function setChannelMode(mode) {
    ...
    if (mode === 'Saluran Kiri') document.getElementById('leftChannelBtn').classList.add('active');
    else if (mode === 'Saluran Kanan') document.getElementById('rightChannelBtn').classList.add('active');
    else if (mode === 'Kedua Saluran') document.getElementById('bothChannelsBtn').classList.add('active');
}
...
function stopAll() {
    ...
    playStopText.innerText = 'Mulai Pemutaran';
    audioStatusDisplay.innerText = 'Berhenti';
...
function startOscillator(freq) {
    ...
    playStopText.innerText = 'Hentikan Pemutaran';
    currentFrequencyDisplay.innerText = freq + ' Hz';
    audioStatusDisplay.innerText = 'Pemutaran Gelombang Sinus';
}
...
function startSweep() {
    ...
    audioStatusDisplay.innerText = 'Luas';
    ...
    oscillator.onended = function() {
        ...
        audioStatusDisplay.innerText = 'Sapu Selesai';
        setTimeout(() => {
...
function startNoise(type) {
    ...
    playStopBtn.classList.add('playing');
    playStopText.innerText = 'Hentikan Pemutaran';
    currentFrequencyDisplay.innerText = type === 'white' ? 'Kebisingan Putih' : 'Kebisingan Merah Muda';
    audioStatusDisplay.innerText = (type === 'white' ? 'White' : 'Pink') + 'Pemutaran Kebisingan';
...
document.getElementById('leftChannelBtn').onclick = () => setChannelMode('Saluran Kiri');
document.getElementById('bothChannelsBtn').onclick = () => setChannelMode('Kedua Saluran');
document.getElementById('rightChannelBtn').onclick = () => setChannelMode('Saluran Kanan');
