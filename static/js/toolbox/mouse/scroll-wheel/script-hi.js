...
function initScrollBox() {
  for (let i = 1; i <= 500; i++) {
    ...
    div.textContent = `लाइन ${i} - व्हील लाइन बेंचमार्क परीक्षण डेटा`;
...
function handleScrollBoxWheel(e) {
  ...
  lineAnalysis.innerHTML = `प्रति स्क्रॉल पंक्तियाँ: <strong style="color:var(--accent)">${lines}</strong> पंक्तियाँ`;
