...
function initScrollBox() {
  for (let i = 1; i <= 500; i++) {
    ...
    div.textContent = `Dòng ${i} - Dữ liệu kiểm tra benchmark dòng bánh xe`;
...
function handleScrollBoxWheel(e) {
  ...
  lineAnalysis.innerHTML = `Số dòng trên mỗi cuộn: <strong style="color:var(--accent)">${lines}</strong> dòng`;
