...
function clearData() {
    ...
    logContainer.innerHTML = '<div class="text-slate-500 italic">डेटा की प्रतीक्षा में...</div>';
    eventCountEl.innerText = `0 घटनाएँ`;
...
function downloadCSV() {
    if (logs.length === 0) {
        alert('निर्यात करने के लिए कोई डेटा नहीं. कृपया पहले परीक्षण करें.');
        return;
    }
...
function init() {
    ...
    initialLog.textContent = `परीक्षण उपकरण तैयार (${startTime}) - परीक्षण के लिए माउस को घुमाना शुरू करें`;
