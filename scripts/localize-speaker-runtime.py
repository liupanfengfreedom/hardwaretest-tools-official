...
TARGET_DIR = ROOT / "static" / "js" / "toolbox" / "speaker"
SOURCE = TARGET_DIR / "script-en.js"
LOCALES = ["es", "fr", "ar", "bn", "pt", "ru", "ur", "id", "de", "mr", "te", "tr", "ta", "pcm"]
CACHE_PATH = ROOT / "scripts" / ".speaker-runtime-cache.json"
...
PCM_MAP = {
    ...
    "Sine Wave Playing": "Sine wave dey play",
    "Sweeping": "Sweeping",
    "Sweep Complete": "Sweep don finish",
    "White Noise": "White noise",
    "Pink Noise": "Pink noise",
    "White Noise Playing": "White noise dey play",
    "Pink Noise Playing": "Pink noise dey play",
}
...
def translate(locale: str, text: str) -> str:
    ...
    raise RuntimeError(f"speaker translate failed for {locale}: {last_error}")
